...
function GetProfile2({
  username, avatar_url, public_repos, location, userLanguage, followers,
  firstAvatar_Url, firstUsername, firstUserLocation, firstUserLanguage, firstUserRepos, firstUserFollowers,
}) {
  return (
    <div className="card">
